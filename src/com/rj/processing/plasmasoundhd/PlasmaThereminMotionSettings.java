...
public class PlasmaThereminMotionSettings extends SettingsFragment implements OnSharedPreferenceChangeListener, PresetListener {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    		Bundle savedInstanceState) {
    	return inflater.inflate(R.layout.motionsettings, container);
    }
