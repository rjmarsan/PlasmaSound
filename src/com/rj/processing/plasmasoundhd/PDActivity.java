...
//	public static final String PATCH_PATH = "simplesine4.2.pd";
	...
	int getMenu() { 
		if (frag != null) 
			...
			return com.rj.processing.plasmasounddonate.R.menu.main_menu; 
	}
	...
	public void onCreate(final Bundle savedinstance) {
		...
		if (Launcher.getUIType() != Launcher.GINGERBREAD_PHONE) {
			preferenceview = this.getLayoutInflater().inflate(
							com.rj.processing.plasmasounddonate.R.layout.prefsoverlay,
							null);
	...
	void setupActionbar() {
	    ...
	    actionBar.addTab(actionBar.newTab().setText(com.rj.processing.plasmasounddonate.R.string.instrument_name)
	    ...
	    actionBar.addTab(actionBar.newTab().setText(com.rj.processing.plasmasounddonate.R.string.sequencer_name)
	            .setTabListener(new TabListener() {
					@Override
...
//	    inflater.inflate(getMenu(), menu);
	...
	public boolean onMenuItemSelected(final int featureId, final MenuItem item) {
	    ...
	    case com.rj.processing.plasmasounddonate.R.id.sequencer_settings:
	        sequencerSettings();
	        return true;
	    case com.rj.processing.plasmasounddonate.R.id.instrument:
	        instrument();
	        return true;
	    ...
	    case com.rj.processing.plasmasounddonate.R.id.load_settings:
	        loadSettings();
	        return true;
	    case com.rj.processing.plasmasounddonate.R.id.load_sequence_settings:
	        loadSequenceSettings();
	        return true;
	    case com.rj.processing.plasmasounddonate.R.id.save_sequence_settings:
	        saveSequenceSettings();
	        return true;
	    case com.rj.processing.plasmasounddonate.R.id.clear_sequence_settings:
	        clearSequenceSettings();
	        return true;
	    case com.rj.processing.plasmasounddonate.R.id.about:
	        about();
	        return true;
	    case com.rj.processing.plasmasounddonate.R.id.record:
	        record();
	        return true;
	    case com.rj.processing.plasmasounddonate.R.id.tutorial:
	        showTutorialDialog();
	        return true;
...
//		this.startActivity(i);
	...
	public void instrumentSettings() {
		...
		View fragment = this.findViewById(com.rj.processing.plasmasounddonate.R.id.audiosettings);
		View fragment2 = this.findViewById(com.rj.processing.plasmasounddonate.R.id.instsettings);
		View fragment3 = this.findViewById(com.rj.processing.plasmasounddonate.R.id.sequencersettings);
		if (fragment != null && fragment2 != null) {
			...
			if (fragment.isShown()) {
				...
				fragment.setBackgroundDrawable(getResources().getDrawable(com.rj.processing.plasmasounddonate.R.drawable.gradient));
			}
		}
	}
	...
	public void sequencerSettings() {
		...
		if (fragment != null && fragment2 != null) {
			...
			if (fragment3.isShown()) {
				...
				fragment3.setBackgroundDrawable(getResources().getDrawable(com.rj.processing.plasmasounddonate.R.drawable.gradient));
			}
		}
	}
	...
	public void effectSettings() {
		...
		View fragment = this.findViewById(com.rj.processing.plasmasounddonate.R.id.instsettings);
		View fragment2 = this.findViewById(com.rj.processing.plasmasounddonate.R.id.audiosettings);
		View fragment3 = this.findViewById(com.rj.processing.plasmasounddonate.R.id.sequencersettings);
		if (fragment != null && fragment2 != null) {
			fragment2.setVisibility(View.GONE);
			fragment3.setVisibility(View.GONE);
	...
	public void record() {
		...
		if (filename != null) {
		    ...
		    share.putExtra(Intent.EXTRA_TEXT, Utils.frmRes(this, com.rj.processing.plasmasounddonate.R.string.export_extra_text));

		    startActivity(Intent.createChooser(share, Utils.frmRes(this, com.rj.processing.plasmasounddonate.R.string.export_extra_title)));
		    
			Toast.makeText(this, Utils.frmRes(this, com.rj.processing.plasmasounddonate.R.string.export_toast_record_finished)+filename, Toast.LENGTH_LONG).show();

		} else {
			Toast.makeText(this, Utils.frmRes(this, com.rj.processing.plasmasounddonate.R.string.export_toast_record_started), Toast.LENGTH_LONG).show();
		}
	}
